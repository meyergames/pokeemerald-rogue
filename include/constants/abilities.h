...
#define ABILITY_D2D_GREENHOUSE 		ABILITIES_COUNT_ROGUE + 1
#define ABILITY_D2D_BLEND_IN 		ABILITIES_COUNT_ROGUE + 2
#define ABILITY_D2D_CLONE			ABILITIES_COUNT_ROGUE + 3
#define ABILITY_D2D_BELLOW			ABILITIES_COUNT_ROGUE + 4
#define ABILITY_D2D_ELEMENTAL		ABILITIES_COUNT_ROGUE + 5
#define ABILITY_D2D_INFINITY		ABILITIES_COUNT_ROGUE + 6

#define ABILITIES_COUNT_D2D 		ABILITY_D2D_INFINITY + 1
