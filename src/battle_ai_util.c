...
static const u16 sEncouragedEncoreEffects[] =
{
    ...
    EFFECT_DRAGON_DANCE,
    EFFECT_CAMOUFLAGE,
    EFFECT_D2D_INSPIRATION,
    EFFECT_D2D_ENERGIZE,
    EFFECT_D2D_ECHOLOCATION,
    EFFECT_D2D_TEACH,
    EFFECT_D2D_SCARECROW,
    EFFECT_D2D_FULL_RESTORE,
    EFFECT_D2D_IMBUE_ELECTRIC,
    EFFECT_D2D_IMBUE_FIRE,
    EFFECT_D2D_IMBUE_ICE,
    EFFECT_EXPLOSION,
    EFFECT_D2D_FATAL_STING,
    EFFECT_D2D_SPECIAL_DEFENSE_UP_3,
};
...
s32 AI_DecideKnownAbilityForTurn(u32 battlerId)
{
    ...
    if ( knownAbility == ABILITY_SHADOW_TAG || knownAbility == ABILITY_MAGNET_PULL || knownAbility == ABILITY_ARENA_TRAP || knownAbility == ABILITY_D2D_BUG_CATCHER )
        return knownAbility;
