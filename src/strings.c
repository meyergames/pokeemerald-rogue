...
const u8 gText_QuickHealMode[] = _("Quick Heal Mode");
...
const u8 gText_TextQuickHealLiberal[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Liberal");
const u8 gText_TextQuickHealConservative[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Conservative");
