...
const struct BattleMove gBattleMoves_Mainline[MOVES_COUNT_DYNAMAX] =
{
    ...
    {
        // .effect = EFFECT_ACCURACY_DOWN_HIT,
        .effect = EFFECT_D2D_ACCURACY_DOWN_2_HIT,
        .power = 100,
        .type = TYPE_WATER,
        .accuracy = 50,
        .pp = 5,
    ...
    {
        .effect = EFFECT_D2D_SERENE_SCENT,
        .power = 0,
        .type = TYPE_GRASS,
        .accuracy = 100,
        .pp = 10,
    ...
    {
        .effect = EFFECT_D2D_MANDIBLE_JAW,
        .power = 80,
        .type = TYPE_BUG,
        .accuracy = 100,
        .pp = 20,
    ...
    [MOVE_D2D_INSPIRATION] =
    {
        .effect = EFFECT_D2D_INSPIRATION,
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 0,
        .pp = 20,
