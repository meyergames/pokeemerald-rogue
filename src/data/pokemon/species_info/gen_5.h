...
#define SAMUROTT_MISC_INFO                                                  \
    ...
    [SPECIES_ROGGENROLA] =
    {
        ...
        .abilities = { ABILITY_STURDY, ABILITY_D2D_TECTONIC, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_BLUE,
...
#define MELOETTA_MISC_INFO                                                              \
    ...
    [SPECIES_MELOETTA_ARIA] =
    {
        ...
        .baseSpAttack  = 128,
        .baseSpDefense = 128,
        .types = { TYPE_STELLAR, TYPE_PSYCHIC },
        .evYield_SpAttack = 1,
        .evYield_SpDefense = 1,
        .description = POKEDEX_DESC_STRING(
    ...
    [SPECIES_MELOETTA_PIROUETTE] =
    {
        ...
        .baseSpAttack  = 77,
        .baseSpDefense = 77,
        .types = { TYPE_STELLAR, TYPE_FIGHTING },
        .evYield_Attack = 1,
        .evYield_Defense = 1,
        .description = POKEDEX_DESC_STRING(
