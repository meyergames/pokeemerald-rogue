...
#define SCEPTILE_MISC_INFO                                  \
    ...
    [SPECIES_SCEPTILE] =
    {
        ...
        .types = { TYPE_GRASS, TYPE_GRASS },
        .expYield = 239,
        .abilities = { ABILITY_OVERGROW, ABILITY_D2D_HYBRID_POWER, ABILITY_UNBURDEN },
        .cryId = CRY_SCEPTILE,
        .height = 17,
        .weight = 522,
        .description = POKEDEX_DESC_STRING(
...
#define BLAZIKEN_MISC_INFO                                  \
    ...
    [SPECIES_BLAZIKEN] =
    {
        ...
        .baseSpDefense = 70,
        .expYield = 239,
        .abilities = { ABILITY_BLAZE, ABILITY_D2D_HYBRID_POWER, ABILITY_SPEED_BOOST },
        .cryId = CRY_BLAZIKEN,
        .description = POKEDEX_DESC_STRING(
...
#define SWAMPERT_MISC_INFO                                      \
    ...
    [SPECIES_SWAMPERT] =
    {
        ...
        .baseSpDefense = 90,
        .expYield = 241,
        .abilities = { ABILITY_TORRENT, ABILITY_D2D_HYBRID_POWER, ABILITY_DAMP },
        .cryId = CRY_SWAMPERT,
        .height = 15,
        .weight = 819,
        .description = POKEDEX_DESC_STRING(
...
#define LINOONE_MISC_INFO                                                       \
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = { ABILITY_D2D_POLLINATOR, ABILITY_D2D_POLLINATOR, ABILITY_D2D_AERODYNAMIC },
    ...
    [SPECIES_DUSTOX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_COMPOUND_EYES, ABILITY_D2D_AERODYNAMIC },
        .bodyColor = BODY_COLOR_GREEN,
...
#define GALLADE_MISC_INFO                                   \
    ...
    [SPECIES_NINJASK] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = { ABILITY_SPEED_BOOST, ABILITY_D2D_AERODYNAMIC, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_WHISMUR] =
    {
        ...
        .baseSpAttack  = 51,
        .baseSpDefense = 23,
        .types = { TYPE_STELLAR, TYPE_STELLAR },
        .catchRate = 190,
        .expYield = 48,
        .evYield_HP = 1,
        .genderRatio = PERCENT_FEMALE(50),
...
#define MEDICHAM_MISC_INFO                                          \
    ...
    [SPECIES_MEDICHAM] =
    {
        ...
        .baseSpDefense = 75,
        .expYield = 144,
        .abilities = { ABILITY_PURE_POWER, ABILITY_TELEPATHY, ABILITY_D2D_HYBRID_POWER },
        .cryId = CRY_MEDICHAM,
        .description = POKEDEX_DESC_STRING(
...
#define CAMERUPT_MISC_INFO                                  \
    ...
    [SPECIES_CAMERUPT] =
    {
        ...
        .baseSpDefense = 75,
        .expYield = 161,
        .abilities = { ABILITY_ROCKY_PAYLOAD, ABILITY_SOLID_ROCK, ABILITY_ANGER_POINT },
        .cryId = CRY_CAMERUPT,
        .height = 19,
        .weight = 2200,
        .description = POKEDEX_DESC_STRING(
    ...
    [SPECIES_CACTURNE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_GRASS, EGG_GROUP_HUMAN_LIKE },
        .abilities = { ABILITY_SAND_RUSH, ABILITY_D2D_HYBRID_POWER, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_GREEN,
...
#define ALTARIA_MISC_INFO                                   \
    ...
    [SPECIES_ALTARIA] =
    {
        ...
        .expYield = 172,
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_D2D_AERODYNAMIC, ABILITY_CLOUD_NINE },
        .cryId = CRY_ALTARIA,
        .height = 11,
        .weight = 206,
        .description = POKEDEX_DESC_STRING(
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .abilities = { ABILITY_SHED_SKIN, ABILITY_D2D_HYBRID_POWER, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
...
#define CASTFORM_MISC_INFO                                      \
    ...
    [SPECIES_KECLEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_COLOR_CHANGE, ABILITY_PROTEAN, ABILITY_D2D_ELEMENTAL },
        .bodyColor = BODY_COLOR_GREEN,
...
#define BANETTE_MISC_INFO                                           \
    ...
    [SPECIES_CHIMECHO] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = { EGG_GROUP_AMORPHOUS, EGG_GROUP_AMORPHOUS },
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_HEALER },
        .bodyColor = BODY_COLOR_BLUE,
...
#define GLALIE_MISC_INFO                                    \
    ...
    [SPECIES_GLALIE] =
    {
        ...
        .baseSpDefense = 80,
        .expYield = 168,
        .abilities = { ABILITY_ICE_BODY, ABILITY_D2D_HYBRID_POWER, ABILITY_MOODY },
        .cryId = CRY_GLALIE,
        .height = 15,
        .weight = 2565,
        .description = POKEDEX_DESC_STRING(
    ...
    [SPECIES_LUVDISC] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = { EGG_GROUP_WATER_2, EGG_GROUP_WATER_2 },
        .abilities = { ABILITY_HEALER, ABILITY_HEALER, ABILITY_TRIAGE },
        .bodyColor = BODY_COLOR_PINK,
...
#define METAGROSS_MISC_INFO                                     \
    ...
    [SPECIES_REGISTEEL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_NO_EGGS_DISCOVERED, EGG_GROUP_NO_EGGS_DISCOVERED },
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_LIGHT_METAL, ABILITY_SAND_STREAM },
        .bodyColor = BODY_COLOR_GRAY,
        .isLegendary = TRUE,
...
#define DEOXYS_MISC_INFO                                                \
        ...
        .growthRate = GROWTH_SLOW,                                      \
        .eggGroups = { EGG_GROUP_NO_EGGS_DISCOVERED, EGG_GROUP_NO_EGGS_DISCOVERED },\
        .abilities = { ABILITY_PRESSURE, ABILITY_NONE, ABILITY_D2D_HYBRID_POWER },\
        .bodyColor = BODY_COLOR_RED,                                    \
        .isMythical = TRUE,                                             \
